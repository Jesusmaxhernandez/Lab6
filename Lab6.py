...
# -*- coding: utf-8 -*-
"""
Created on Tue Dec  4 23:49:04 2018

@author: JesusMHernandez
"""

from KruskalTop import topological_sort
from KruskalTop import kruskals_alg
...
def main():
  ...
  print("A minimum spanning tree for graph 1 can be created from the following edges:")
  #for value in kruskals_alg(graph_kruskals):
   # print(value)
